...
/*
interface ITreeNodeHash<K, T> {
   [id: number]: TreeNode<K, T>;
}
*/
/**
 * AVL Balanced Binary Tree Index implementation which supports duplicate values and ranged queries.
 * AVL functionality guided primarily by William Fiset tutorials at :
